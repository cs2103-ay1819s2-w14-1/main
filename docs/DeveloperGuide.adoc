...
[[Design-Storage]]
=== Spaced Repetition System (SRS) component
...
// tag::import/exportuser
=== import/export feature
The import/export feature allows user to import CSV files into object and export objects to CSV files.

==== Current Implementation
The import/export feature currently contains 2 commands to xxxxxxxxx

* 'importuser' - Imports the selected CSV file and load the current progress of the user.
* *exportuser' - Exports the current progress of the user into a CSV file.
...
// tag::quiz[]
=== Quiz feature
The Quiz feature allows users to enter quiz related commands and answer.

==== Current Implementation
The Quiz feature currently contains 4 commands to xxxxxxxxxxxxxx and answer input.

* `\quit` - Quits a quiz session.
...
* `Answer [*]` - Enters any character without escape character \ is treated as an answer.
